...
main (int argc, char **argv)
{
	...
	pmap_unset (CALCULADORA, OPERACIONES);
	...
	if (!svc_register(transp, CALCULADORA, OPERACIONES, calculadora_1, IPPROTO_UDP)) {
		fprintf (stderr, "%s", "unable to register (CALCULADORA, OPERACIONES, udp).");
		exit(1);
	}
	...
	if (!svc_register(transp, CALCULADORA, OPERACIONES, calculadora_1, IPPROTO_TCP)) {
		fprintf (stderr, "%s", "unable to register (CALCULADORA, OPERACIONES, tcp).");
		exit(1);
	}
